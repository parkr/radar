...
func generateRadar(radarItemsService radar.RadarItemsService, ticker *time.Ticker, hourToGenerateRadar string) {
...
func main() {
	...
	go generateRadar(radarItemsService, ticker, hourToGenerateRadar)
